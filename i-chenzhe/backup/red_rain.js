...
等待通知提示获取参数成功即可。
脚本更新地址：https://raw.githubusercontent.com/monk-coder/dust/dust/i-chenzhe/red_rain.js
脚本兼容: Quantumult X
==========Quantumult X==========
[task_local]
#京东直播雨
0,50 0,9,11,13,15,17,19,20,21,23 8-18 2 * https://raw.githubusercontent.com/monk-coder/dust/dust/i-chenzhe/red_rain.js, tag=京东直播雨, enabled=true
[rewrite_local]
^https://api\.m\.jd\.com/client\.action\?functionId\=liveActivityV842 url script-request-body https://raw.githubusercontent.com/monk-coder/dust/dust/i-chenzhe/get_red_rain.js
 */
const $ = new Env('红包雨');
